<?php
	...
	$mail->Subject = utf8_encode('=?UTF-8?B?' . base64_encode('Generación de contraseña para la administración del restaurante') .  '?='); // Asunto del mensaje
	      ...
	      <tr>
	        <td><table width="100%" border="0">
	          ...
	          <tr>
	            ...
	            <span>Como previamente ha solicitado, su contraseña para nuestra área de administración ha sido reiniciada. sus nuevos detalles de sesión son:</span>
	            </td>
	          </tr>
	          <tr>
	            <td>&nbsp;</td>
	          ...
	          <tr>
	            <td style="font-family: Helvetica LT Condensed; font-size: 18px;"><span>CIF restaurante:</span>&nbsp;'.$id_restaurant.'</td>
	          </tr>
	          <tr>
	          ...
	          <tr>
	            <td style="font-family: Helvetica LT Condensed; font-size: 18px;">
	            <span>Para cambiar tu contraseña a algo más fácil de recordar, luego de iniciar sesión ingresa en Información > Cambiar Contraseña.</span>
	            </td>
	          </tr>
	          <tr>
	            <td>&nbsp;</td>
