<?php
	...
	$email_code=$user->getUserEmailCode($email); // Obtenemos el 'email_code' del usuario teniendo en cuenta el email
	...
	$mail->Subject = utf8_encode('=?UTF-8?B?' . base64_encode('Activación de cuenta de usuario') .  '?='); // Asunto del mensaje
	      ...
	      <tr>
	        <td><table width="100%" border="0">
	          ...
	          <tr>
	            ...
	            <spanHelvetica LT Condensed"; font-size: 18px;"><p>Estimado&nbsp;'.$username.',</p></span>
	            <span>Gracias por registrarse con nosotros. Por favor visite el siguiente enlace para que podamos activar su cuenta:</span>
	            </td>
	          </tr>
	          <tr>
	            <td style="font-family: Helvetica LT Condensed; font-size: 18px;">
	            <span><a href="http://vps62618.ovh.net/user/activate.php?email='.$email.'&email_code='.$email_code.'">http://vps62618.ovh.net/user/activate.php?'.$email.'&email_code='.$email_code.'</a></span>
	            </td>
	          </tr>
	          <tr>
	            <td>&nbsp;</td>
	          ...
	          <tr>
	            <td style="font-family: Helvetica LT Condensed; font-size: 18px;"><span style="font-weight: bold">Informaci&oacute;n de su cuenta:</span>&nbsp;</td>
	          </tr>
	          <tr>
	            <td style="font-family: Helvetica LT Condensed; font-size: 18px;"><span>Nombre Completo:</span>&nbsp;'.$name.'&nbsp;'.$surnames.'</td>
	          </tr>
	          <tr>
