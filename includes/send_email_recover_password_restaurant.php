<?php
	...
	$generated_string=$restaurant->getRestaurantGeneratedString($_POST['email']); // Obtenemos el 'generated_string' del restaurante teniendo en cuenta el email
	...
	$mail->AddAddress($_POST['email']); // Destinatario del mensaje

	$mail->IsHTML(true); // 'true' en caso de enviar un mensaje HTML

	$mail->Subject = utf8_encode('=?UTF-8?B?' . base64_encode('Recuperación de contraseña de la administración del restaurante') .  '?='); // Asunto del mensaje
	      ...
	      <tr>
	        <td><table width="100%" border="0">
	          ...
	          <tr>
	            ...
	            <span><a href="http://vps62618.ovh.net/admin/recover.php?email='.$_POST['email'].'&generated_string='.$generated_string.'">http://vps62618.ovh.net/admin/recover.php?email='.$_POST['email'].'&generated_string='.$generated_string.'</a></span>
	            </td>
	          </tr>
	          <tr>
	            <td>&nbsp;</td>
