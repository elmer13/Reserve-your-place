<?php
	...
	// Archivo llamado desde ajax para filtrar la búsqueda de restaurantes por ciudad
    ...
    function buscar($b){
      	...
      	$restaurant->getByCity($b);  // Obtenemos la información del restaurante teniendo en cuenta la ciudad definida en la variable '$b'
