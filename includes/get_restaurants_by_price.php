<?php
	...
	// Archivo llamado desde ajax para filtrar la búsqueda de restaurantes por precio de menú
    ...
    // Función que recibirá el filtro para el buscador 
      ...
      function buscar($b){
        ...
        include_once '../core/init.php';  // Incluimos el archivo init.php que contiene las instancias de las diferentes clases 
         ...
         // Obtenemos la información del restaurante teniendo en cuenta el precio seleccionado en la variable '$b'

        if($b==1){

            $restaurant->getMenuPrice0And20(); // de 0 a 20€

        }else if($b==2){

            $restaurant->getMenuPrice20And40(); // de 20 a 40€                

        }else if($b==3){

            $restaurant->getMenuPrice40And60();  // de 40 a 60€               

        }else if($b==4){

            $restaurant->getMenuPrice60And80();  // de 60 a 80€               

        }else if($b==5){

            $restaurant->getMenuPrice80And100(); // de 80 a 100€                

        }else if($b==6){

            $restaurant->getMenuPriceMoreOf100();  // Más de 100€               
