<?php
      ...
      // Archivo llamado desde ajax para filtrar la búsqueda de restaurantes por nota media

     include_once '../core/init.php';  // Incluimos el archivo init.php que contiene las instancias de las diferentes clases 
       

      $minimo = $_POST['b']; // Recogemos la variable 'b' enviada por 'POST' y la almacenamos en una variable
      $maximo = $_POST['c']; // Recogemos la variable 'c' enviada por 'POST' y la almacenamos en una variable

      if((!empty($minimo)) && !empty($maximo)){ // Siempre y cuando la variable sea diferente de vacio hacemos lo siguiente

      $restaurant->getRestaurantsByNote($minimo,$maximo); // Obtenemos la información del restaurante teniendo en cuenta el rango de nota seleccionado
