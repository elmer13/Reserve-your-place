/**************************************************************************************************************************************/
/*	Fichero js que se encargará de cargar los datos mediante ajax partiendo de la consulta en el fichero get_restaurants_by_price.php */
/**************************************************************************************************************************************/
$(document).ready( function (){
	...
	$('#precios').change(function(){
        ...
        $.ajax({
            ...
            url: 'includes/get_restaurants_by_price.php', // llamada al archivo php
            data: 'b='+option, // parametros que se envian
